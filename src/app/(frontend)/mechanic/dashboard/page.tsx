...
import { MechanicNavbar } from '@/components/ascMechanicBar'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { JobCardList, JobCardData } from '@/components/ascJobCardMechanicList'
import { JobCardForm } from '@/components/ascJobCardMechanicForm'
    ...
    <div className="min-h-screen bg-muted/20 pb-10">
      ...
      <main className="container py-8 space-y-8">
        <header>
          ...
          <p className="text-muted-foreground">Welcome back, Mechanic. View job cards and start on a task.</p>
        </header>
