  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionHeader}>SERVICES RENDERED & SPARE PARTS</Text>
        <View style={styles.tableHeader}>
          <Text style={styles.colDesc}>Description</Text>
          <Text style={styles.colAmount}>Total (RM)</Text>
        </View>
      ...
      <View style={styles.totalSection}>
        <Text style={{ fontSize: 12, fontWeight: 'bold', marginRight: 10 }}>GRAND TOTAL:</Text>
