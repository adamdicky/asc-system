...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 20, borderBottomWidth: 1, paddingBottom: 10, borderColor: '#ccc' },
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <Text style={{ ...styles.subtitle, marginTop: 4 }}>Job Card Reference: {data.job_card_id}</Text>
      </View>
      ...
      <View style={styles.row}>
        <View style={styles.col}>
          ...
          <Text style={styles.value}>{new Date(data.date_in).toLocaleDateString()}</Text>
        ...
        <View style={styles.col}>
          ...
          <Text style={{ ...styles.value, color: data.status === 'Pending' ? 'red' : 'green' }}>{data.status.toUpperCase()}</Text>
        </View>
      </View>
      ...
      <Text style={styles.footer}>Generated by ASC System UTMKL. {new Date().toLocaleString()}</Text>
    </Page>
  </Document>
)